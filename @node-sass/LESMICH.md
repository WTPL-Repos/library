...
#### Unterstützte Node.js-Versionen variieren je nach deren Release. Unten finden Sie eine Kurzanleitung für minimale Unterstützung:
...
s[![Dependency Status](https://david-dm.org/sass/node-sass.svg?theme=shields.io)](https://david-dm.org/sass/node-sass)
